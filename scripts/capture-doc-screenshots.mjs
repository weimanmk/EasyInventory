      ...
      invoke: async (cmd, args = {}) => {
        switch (cmd) {
          ...
          case 'get_diagnostic_summary':
            return ok({ databasePath: 'C:/tmp/inventory.db', databaseSize: 2048, version: '1.3.1', backupCount: 1, latestBackupAt: '2026-06-01 09:00:00', productCount: products.length, customerCount: customers.length, orderCount: 1, documentCount: 1, latestLogs: [] });
